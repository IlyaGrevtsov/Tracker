...
final class IrregularEventViewController: UIViewController, UITextFieldDelegate {
    ...
    private func constraint () {
        ...
        [textFiled, tableView, createButton, cancelButton, collectionView].forEach{
...
extension IrregularEventViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "NewHabitTableViewCell", for: indexPath) as? NewHabitTableViewController else { return UITableViewCell() }
